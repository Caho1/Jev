...
该数据集来自于**WWW2025 多模态对话系统意图识别挑战赛**，网址：https://tianchi.aliyun.com/competition/entrance/532277/information 。数据集中包括 1000 个标记的对话样本用于训练。

# 2. 数据介绍

该数据集全部为文本结合图像的分类任务，包含 2 大类：图片场景分类以及多轮对话意图分类。
...
| 评论区截图页面 | 在淘宝 APP 内或其他 APP 内的评论区截图 |
...
| 外部 APP 截图 | 各种非淘宝、菜鸟 APP 的截图，包括京东、拼多多、短信、手机系统截图 |
| 平台介入页面 | 平台客服介入处理的截图 |
| 其他类别图片 | 拿不准的其他图片 |
...
| 单品推荐 | 消费者咨询能否帮助推荐一下某类/某个商品，非 sku 级别 |
...
# 4. 总结
## 数据集地址
https://www.modelscope.cn/datasets/smau0441/www2025-train
## 模型地址
https://www.modelscope.cn/models/smau0441/Fluoroscope
## 服务地址
https://www.modelscope.cn/studios/smau0441/Fluoroscope