...
该数据集来自于**WWW2025 多模态对话系统意图识别挑战赛**，网址：https://tianchi.aliyun.com/competition/entrance/532277/information 。

通过对竞赛提供的 **测试集1、测试集2** 进行模型标注和人工核验，同时结合 **训练集** 数据。经过筛选，最终确定了 **17442 条** 数据。
